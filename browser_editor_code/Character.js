...
// 이미지 변수에 style 속성 삽입.
character_img1.style="position: fixed; top: 0px; left: 0px; z-index: 899; width: 170px; height: 170px; visibility=hidden";
...
character_img1.onmousedown = function(event) {
    ...
    function onMouseMove(event) {
        CharacterMoveAt(event.clientX, event.clientY);
    }
...
function moveCharacter(absoluteLeft, absoluteTop) {
    ...
    character_img1.style="position: absolute; top: "+absoluteTop+"px; left: "+absoluteLeft+"px; z-index: 899; width: 170px; height: 170px; visibility=visible";
